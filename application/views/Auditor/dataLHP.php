	...
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12"><br>
				...
				<?php endif; ?><br>
				<a class="btn btn-primary mb-3 mt-3" href="<?= base_url(); ?>DataLHP/tambah">Input Temuan LHP</a></button><br><br>
				<div class="adv-table">
						...
						<tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url()."DataLHP/edit/".$u['id_lhp']; ?>">
	                				<button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button>
                                    <a href="<?= base_url()."DataLHP/delete/".$u['id_lhp']; ?>">
                                    ...
                                    <a href="<?= base_url('DataLHP/detail/'.$u['id_lhp'])?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php endforeach;?>
						</tbody>
