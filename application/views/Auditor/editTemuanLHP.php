<section id="main-content">
	<section class="wrapper">
		<br>
		<center>
			<h3 style="color: black;">Edit Temuan LHP</h3>
		</center>
		<div class="row mt">
			<div class="col-lg-12">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="temuan" class="form-control"
									value="<?php echo set_value('temuan', $result->temuan) ?>">
							</div>
						</div>
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button class="btn btn-theme" type="submit">Save</button>
								<a class="btn btn-theme04" type="button" href="<?= base_url('DataLHP/detail/'.$result->id_lhp) ?>">Cancel</a>
							</div>
						</div>
					</form>
				</div>
