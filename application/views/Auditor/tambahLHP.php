		...
		<div class="row mt">
			<div class="col-lg-12">
				<div class="form-panel">
					...
					<?php echo form_open_multipart('DataLHP/tambah', array('class' => 'form-horizontal style-form', 'needs-validation', 'novalidate' => '')); ?>
					<form>
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								...
								<a class="btn btn-theme04" type="button" href="<?= base_url() ?>DataLhp">Cancel</a>
							</div>
						</div>
					</form>
					<?= form_close(); ?>
