        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <a class="btn btn-theme04" type="button" href="<?= base_url('Admin/detail2/'.$lhpdata[0]['id_lhp']) ?>"><i class="fa fa-arrow-left "></i> Back</a>
                </div>
                <div class="col-lg-8">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if ($u['keterangan'] == NULL) { ?>
                                        <a href="<?= base_url()."Admin/TindakLanjut/".$u['id_rekomendasi']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a> <?php
                                    }else { ?>
