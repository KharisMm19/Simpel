			...
			<div class="row">
				<div class="col-lg-6">
					...
					<table class="table table-bordered table-striped table-condensed text-center">
						...
						<tbody>
							<tr>
								<td class="text-center"><?= $temuan2 ?></td>
								...
								<a class="btn btn-theme04" type="button" href="<?= base_url('Admin/DataTindakLanjut/'.$lhpdata[0]['id_skpd']) ?>"><i
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<a href="<?= base_url()."Admin/lihatRekomendasiTL/".$u['id_temuan']; ?>"
