				...
				<div class="form-panel">
                    ...
                    <form>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
								<textarea type="text" name="temuan" class="form-control"
									value="<?php echo set_value('temuan', $result->temuan) ?>" readonly><?php echo set_value('temuan', $result->temuan) ?></textarea>
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Rekomendasi</label>
							<div class="col-sm-10">
								<textarea type="text" name="rekomendasi" class="form-control"
									value="<?php echo set_value('rekomendasi', $result->rekomendasi) ?>" readonly><?php echo set_value('rekomendasi', $result->rekomendasi) ?></textarea>
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Deskripsi<br> Usulan Tindak Lanjut</label>
							<div class="col-sm-10">
								<input type="text" name="keterangan" class="form-control" placeholder="Isi Deskripsi Usulan Tindak Lanjut">
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Upload File<br> (.pdf, .doc, .docx, .ppt, .pptx, .csv, .xlsx, .xls, .zip, .rar)</label>
							<div class="col-sm-10">
								<input type="file" name="image[]" class="form-control-file" multiple='multiple'>
							</div>
						</div>
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button class="btn btn-theme" type="submit">Save</button>
								<a class="btn btn-theme04" type="button" href="<?= base_url('Skpd/lihatRekomendasi/'.$result->id_temuan) ?>">Cancel</a>
							</div>
						</div>
					</form>
				</div>
