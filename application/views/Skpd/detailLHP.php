        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <a class="btn btn-theme04" type="button" href="<?= base_url()."Skpd/temuan/".$id_skpd; ?>"><i class="fa fa-arrow-left "></i> Back</a>
                </div>
                <div class="col-lg-8">
                    <h4>Temuan</h4>
						...
						<tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url()."Skpd/lihatRekomendasi/".$u['id_temuan']; ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php endforeach;?>
						</tbody>
