				...
				<div class="form-panel">
                    ...
                    <form>
						<div class="form-group" hidden>
							<label class="col-sm-2 col-sm-2 control-label">id_skpd</label>
							<div class="col-sm-10">
								<input type="text" name="id_skpd" class="form-control" value="<?= $id_skpd ?>">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								...
								<a class="btn btn-theme04" type="button" href="<?= base_url('Skpd/index/'.$id_skpd) ?>">Cancel</a>
							</div>
						</div>
					</form>
				</div>
