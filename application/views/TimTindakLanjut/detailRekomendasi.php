        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <a class="btn btn-theme04" type="button" href="<?= base_url('TimTindakLanjut/lihatRekomendasiTL/'.$lhpdata[0]['id_temuan']) ?>"><i class="fa fa-arrow-left "></i> Back</a>
                </div>
                <div class="col-lg-6">
                    ...
                    <h4><strong>Rekomendasi : </strong><?= $lhpdata[0]['rekomendasi']?><?php 
                                ...
                                ?></h4> <a class="btn-sm btn-primary" type="button" href="<?= base_url('TimTindakLanjut/halamanVerifikasi/'.$lhpdata[0]['id_rekomendasi']) ?>"><i class="fa fa-pencil "></i> Ubah Status</a><hr>
