        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <a class="btn btn-theme04" type="button" href="<?= base_url('TimTindakLanjut/detailTindakLanjut/'.$lhpdata[0]['id_lhp']) ?>"><i class="fa fa-arrow-left "></i> Back</a>
                </div>
                <div class="col-lg-8">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered"
						...
						<tbody>
                            ...
                            <tr>
                                <td class="text-center"><?= $u['rekomendasi']?><br><?php 
                                    if ($u['status'] == 'Sesuai') { ?>
                                ...
                                <td class="text-center">
									...
									if($u['keterangan'] != NULL){
										?><a href="<?= base_url()."TimTindakLanjut/detailTL/".$u['id_rekomendasi']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a><?php
									}else { ?>
